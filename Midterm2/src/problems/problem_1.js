...
const explanation = `(The celesius wont change due to it is stored in a local variable. Everytime when react rerender the Problem function component, the celsius variable is set to -40 degree )`;
...
export function Problem () {
    ...
    return <>
        ...
        <hr />
        {fahrenheit} &deg;F is {celsius} &deg;C
        <p>{explanation}</p>
    </>
}